importScripts('https://lf16-tiktok-common.tiktokcdn-us.com/obj/tiktok-web-common-tx/pns/runtime-worker/2.0.0.2/pns-runtime-sw.js');importScripts('https://storage.googleapis.com/workbox-cdn/releases/4.3.1/workbox-sw.js');
