...
<SCRIPT type=text/javascript> 
	...
	function goEntryPoint() { 
		if(document.getElementById('motivo_contacto_chat').value == ''){
			alert('Por favor selecciona un motivo de contacto');
			document.getElementById('motivo_contacto_chat').focus();
			return;
		}
	
		document.getElementById('motivo_contacto_chat').disabled = true;
	
		div_link_start_chat = document.getElementById('contenedor_link_start_chat');
		//div_link_start_chat.innerHTML = "a continuación da clic: ";
	
		
		div_link_start_chat.innerHTML = "<label class=\"columna_chat\">a continuación da clic:</label>"+
										"<div class=supermenu_columna_small>"+
										"<b>Iniciar chat</b>"+																										
										"</div>";	
		...
		var refererName = document.getElementById('motivo_contacto_chat').value;
		...
		var params = "width=" + w + ",height=" + h + ",left=" + l + ",top=" + t + ",resizable=no,scrollbars=yes,toolbar=no";
			var eGainChatUrl = 'https://chatmegacable.megacable.com.mx/system/templates/chat/template_megacable/chat.html?subActivity=Chat&entryPointId=1001&templateName=template_megacable&languageCode=es&countryCode=ES&ver=v11&eglvrefname='+refererName+'&'+eglvcaseid+vhtIds;
...
<BODY class=alt_font>
	<DIV id=wrapper>
		<DIV id=top_menu>
			...
			<!--
				<DIV id=social_icons>
					<A title=Facebook href="http://facebook.com/megacable"
						target=_blank><IMG border=0 alt=Facebook
						src="ayuda_files/facebook.png" width=16 height=16></A> <A
						title=Twitter href="http://twitter.com/megacable" target=_blank><IMG
						border=0 alt=Twitter src="ayuda_files/twitter.png" width=16
						height=16></A>
				</DIV>
			-->	
		...
		<DIV style="PADDING-TOP: 0px" class=seccion>
			<DIV
				...
				<DIV style="WIDTH: 238px; BACKGROUND: url(ayuda_files/images/layout/backgrounds/bg_menu_cotizador2.jpg) repeat-y right 50%; FLOAT: right" id=menu_cotizador>
				...
				<div style="WIDTH: 642px; BACKGROUND: none transparent scroll repeat 0% 0%; FLOAT: left; MARGIN-LEFT: 30px" id=error_mail_ayuda>
					<BR>
					<!-- <H1 class=gray>CHAT</H1>
					<BR/> -->										
					<DIV class=seccion_contacto>
					<DIV class=titulo_seccion_contacto>Chat</DIV>							
						<!--  -->
						<DIV class=columna_chat>
							<label class="columna_chat">Por favor selecciona un
							motivo de atención </label><font color="red">*</font>: <select class="select_box" style="width: 220px;" id="motivo_contacto_chat" name="motivo_contacto_chat">
				...
				<OPTION value="Quejas y Sugerencias Nuevo">Quejas y Sugerencias</OPTION>
						...
						<div class=columna_chat id="contenedor_link_start_chat">
							<label class="columna_chat">a continuación da clic:</label>
							<div class=supermenu_columna_small>
						 		<a href="javascript:void(0)"
									id="link_start_chat" onClick="goEntryPoint()"
									style="cursor: hand">Iniciar chat
								</a>
							</div>																					
						</div>
